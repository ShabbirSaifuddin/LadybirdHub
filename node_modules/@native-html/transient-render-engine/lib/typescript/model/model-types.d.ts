...
import { Markers, SetMarkersForTNode, TNodeDescriptor, TNodeShape, TNodeType } from '../tree/tree-types';
...
export interface ElementModelBase<T extends string> {
     ...
     * colored blue only when `href` is defined.
     */
    getUADynamicMixedStyles?: (tnode: TNodeDescriptor) => MixedStyleDeclaration | null | undefined | void;
    /**
     * A function to create conditional React Native props for a specific TNode.
     */
    getDynamicReactNativeProps?: (tnode: TNodeShape<TNodeType>) => ReactNativePropsDefinitions | null | undefined | void;
}
/**
