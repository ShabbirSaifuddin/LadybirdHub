...
export default class HTMLElementModel<T extends string, M extends HTMLContentModel> implements HTMLElementModelProperties<T, M> {
     ...
     * colored blue only when `href` is defined.
     */
    readonly getUADynamicMixedStyles: NativeElementModel['getUADynamicMixedStyles'];
    /**
     * A function to pass conditional React Native props to renderers for a specific TNode.
     */
    readonly getDynamicReactNativeProps: NativeElementModel['getDynamicReactNativeProps'];
    /**
