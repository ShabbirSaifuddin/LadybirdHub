...
function useIMGNormalizedSource({
  ...
  const cachedDimensions = (0, _react.useRef)(concreteDimensions);
  const {
  ...
  return (0, _react.useMemo)(() => {
    if (source.uri && typeof provideEmbeddedHeaders === 'function') {
      ...
      const headers = provideEmbeddedHeaders(source.uri, 'img', {
        printWidth: (_cachedDimensions$cur = cachedDimensions.current) === null || _cachedDimensions$cur === void 0 ? void 0 : _cachedDimensions$cur.width,
        printHeight: (_cachedDimensions$cur2 = cachedDimensions.current) === null || _cachedDimensions$cur2 === void 0 ? void 0 : _cachedDimensions$cur2.height
      });
